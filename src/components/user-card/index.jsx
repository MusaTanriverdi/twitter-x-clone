...
export default function UserCard({ user }) {
    ...
    return (
        <button className="py-3 px-4 flex gap-3 transition-colors hover:bg-white/[0.05]">
            <img src={user.avatar} className="w-10 h-10 rounded-full object-cover" alt="" />
            <div className="flex-1 max-w-full flex flex-col text-left font-bold">
                <div className="text-[15px] text-[#e7e9ea] leading-5 flex items-center">
                    {user.fullName}
                    {user?.verified && (
