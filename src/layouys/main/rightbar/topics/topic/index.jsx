    ...
    return (
        <Link to="/" className="py-3 px-4 transition-colors hover:bg-white/[0.03] relative">
            ...
            <Popover className="absolute top-1.5 right-2">
                <Popover.Button className="w-[34.75px] h-[34.75px] outline-none rounded-full text-[#71767b] flex items-center justify-center hover:bg-[#1d9bf01a] hover:text-[#1d9bf0] transition-colors">
