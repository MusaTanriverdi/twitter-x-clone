...
export default function Search() {
    ...
    return (
        ...
        >
            <label className="h-[43px] rounded-full bg-[#202327] block w-full relative group border border-transparent focus-within:bg-black focus-within:border-[#1d9bf0]">
                ...
                />
                {(query && focus) && (
                    <button type="button" onClick={() => setQuery('')} className="w-[22px] h-[22px] rounded-full bg-[#1d9bf0] flex items-center justify-center text-black min-w-[22px] absolute top-1/2 right-3 -translate-y-1/2">
