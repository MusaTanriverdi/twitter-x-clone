...
export default function Footer() {
    return (
        <footer className="mb-4 px-4 flex flex-wrap gap-2">
            ...
            <Link to="/" className="text-[#71767b] leading-4 text-[13px] hover:underline">İmprint</Link>
            ...
            <div className="w-full flex gap-2">
                <Popover className="relative inline-flex leading-4">
                    ...
                    <Popover.Panel className="w-[150px] max-w-[384px] bg-black shadow-box rounded-xl absolute bottom-0 right-0 grid">
                        <Link to="/" className="py-3 px-4 text-white text-[15px] leading-5 font-bold hover:bg-[#16181c] transition-colors overflow-hidden">
                            Hakkında
                        </Link>
                        <Link to="/" className="py-3 px-4 text-white text-[15px] leading-5 font-bold hover:bg-[#16181c] transition-colors overflow-hidden">
                            Durum
                ...
                <p className="text-[#71767b] leading-4 text-[13px]">
                    &copy; 2023 Musa Tanrıverdi Twitter-X clone
                </p>
            </div>
        </footer>
    )
