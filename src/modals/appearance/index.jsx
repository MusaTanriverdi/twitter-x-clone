                    ...
                    <div className="border border-[color:var(--background-third)] px-4 flex py-3 gap-3 rounded-2xl">
                        ...
                        <div className="flex-1 flex flex-col">
                            ...
                            <div className="text-[color:var(--color-base)] leading-5">
                                X'in merkezinde, tıpkı bunun gibi gönderi denen kısa mesajlar yatar. Gönderiler; fotoğraflar, videolar, bağlantılar, metinler, etiketler ve <Link className="text-[#1d9bf0] hover:underline" to="/">@X</Link> gibi bahsetmeler içerebilir.
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <section>
                        ...
                        <div className="py-2 px-4 mb-3 grid gap-2 grid-cols-3 bg-[color:var(--background-secondary)] rounded-2xl">
                            <button
                                ...
                                className={classNames("h-[62px] pr-3 pl-2 bg-white text-[#0f1419] border font-bold border-transparent/10 rounded group flex items-center gap-1.5", {
                                    "!border-[color:var(--color-primary)] !border-2": backgroundColor.name == 'light'
                                })}
                            >
                                <div className="h-[40px] w-[40px] rounded-full flex-shrink-0 group-hover:bg-black/5 flex items-center justify-center">
                                    <div className={classNames("w-[20px] h-[20px] rounded-full border-[2px] border-[#3e4144] flex items-center justify-center", {
                            ...
                            <button
                                ...
                                className={classNames("h-[62px] px-5 bg-[#15202b] text-[#f7f9f9] border font-bold border-transparent/10 rounded group flex items-center gap-1.5", {
                                    "!border-[color:var(--color-primary)] !border-2": backgroundColor.name == 'dark'
                                })}

                            >
                                <div className="h-[40px] w-[40px] rounded-full flex-shrink-0 group-hover:bg-white/5 flex items-center justify-center">
                                    <div className={classNames("w-[20px] h-[20px] rounded-full border-2 border-[#5c6e7e] flex items-center justify-center", {
                            ...
                            <button
                                ...
                                className={classNames("h-[62px] pr-3 pl-2 bg-black text-[#f7f9f9] border font-bold border-transparent/10 rounded group flex items-center gap-1.5", {
                                    "!border-[color:var(--color-primary)] !border-2": backgroundColor.name == 'darker'
                                })}
                            >
                                <div className="h-[40px] w-[40px] rounded-full flex-shrink-0 group-hover:bg-white/5 flex items-center justify-center">
                                    <div className={classNames("w-[20px] h-[20px] rounded-full border-2 border-[#3e4144] flex items-center justify-center", {
